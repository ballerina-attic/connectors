...
connector ClientConnector(string accessToken, string clientId, string clientSecret, string refreshToken, string apiInstance) {
    ...
    action describeGlobal(ClientConnector sf) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action sObjectDescribe(ClientConnector sf, string sobjectName) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sf: The salesforcerest connector instance")
    @doc:Return("response message")
    action listOrganizationLimits(ClientConnector sf) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sf: The salesforcerest connector instance")
    @doc:Param("apiVersion: The api version to get resources")
    @doc:Return("response message")
    action listResourcesByApiVersion(ClientConnector sf, string apiVersion) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sobjectName: The relevant sobject name")
    @doc:Return("response message")
    action sObjectBasicInfo(ClientConnector sf, string sobjectName) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action sObjectGetDeleted(ClientConnector sf, string sobjectName, string startTime, string endTime) (message)
     throws exception {
        string httpMethod;
        string requestURI;
        string host;
    ...
    @doc:Param("endTime: The end time of the time span")
    @doc:Return("response message")
    action sObjectGetUpdated(ClientConnector sf, string sobjectName, string startTime, string endTime) (message)
     throws exception {
        string httpMethod;
        string requestURI;
        string host;
    ...
    @doc:Param("sf: The salesforcerest connector instance")
    @doc:Return("response message")
    action sObjectPlatformAction(ClientConnector sf) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sobjectName: The relevant sobject name")
    @doc:Return("response message")
    action sObjectRows(ClientConnector sf, string sobjectName, string rowId) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action sObjectRowsByExternalId(ClientConnector sf, string sobjectName, string fieldId, string fieldValue) (message)
     throws exception {
        string httpMethod;
        string requestURI;
        string host;
    ...
    @doc:Return("response message")
    action listviewQueryPerformanceFeedback(ClientConnector sf, string listViewId) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action query(ClientConnector sf, string queryString) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("queryString: The request SOQL query")
    @doc:Return("response message")
    action queryAll(ClientConnector sf, string queryString) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sf: The salesforcerest connector instance")
    @doc:Param("nextRecordsUrl: The url sent with first batch of queryAll results for the next batch")
    @doc:Return("response message")
    action queryAllMore(ClientConnector sf, string nextRecordsUrl) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sf: The salesforcerest connector instance")
    @doc:Param("nextRecordsUrl: The url sent with first batch of query results for the next batch")
    @doc:Return("response message")
    action queryMore(ClientConnector sf, string nextRecordsUrl) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("queryString: The request SOQL query")
    @doc:Return("response message")
    action queryPerformanceFeedback(ClientConnector sf, string queryString) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action createRecord(ClientConnector sf, string sobjectName, json payload) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("payload: json payload containing record data")
    @doc:Return("response message")
    action createMultipleRecords(ClientConnector sf, string sobjectName, json payload) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Param("sobjectName: The relevant sobject name")
    @doc:Return("response message")
    action delete(ClientConnector sf, string sobjectName, string deleteId) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
    ...
    @doc:Return("response message")
    action retrieveFieldValues(ClientConnector sf, string sobjectName, string rowId, string fields) (message)
     throws exception {
        string httpMethod;
        string requestURI;
        string host;
    ...
    @doc:Param("fields: The comma separated set of required fields")
    @doc:Return("response message")
    action retrieveFieldValuesFromExternalObject(ClientConnector sf, string sobjectName, string rowId, string fields)
    ...
    @doc:Param("fields: The comma separated set of required fields")
    @doc:Return("response message")
    action retrieveStandardFieldValuesFromExternalObjectWithExternalId(ClientConnector sf, string sobjectName,
    ...
    @doc:Param("payload: json payload containing record data")
    @doc:Return("response message")
    action update(ClientConnector sf, string sobjectName, string recordId, json payload) (message) throws exception {
        string httpMethod;
        string requestURI;
        string host;
        message requestMsg = {};
