...
function testCreateBucket () {
    ...
    http:Response s3Response = s3Connector.createBucket ("BallerinaTest");
    int s3Status = response:getStatusCode(s3Response);
...
function testPutObject () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.putObject ("BallerinaTest", "test.txt", "Sample Content");
    int s3Status = response:getStatusCode(s3Response);
...
function testPutInvalidBucket () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.putObject ("BallerinaTest1", "test.txt", "Sample Content");
    int s3Status = response:getStatusCode(s3Response);
    xml s3XmlResponse = response:getXmlPayload(s3Response);
...
function testGetObject () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.getObject ("BallerinaTest", "test.txt");
    int s3Status = response:getStatusCode(s3Response);
    string s3StringResponse = response:getStringPayload(s3Response);
...
function testGetObjectList () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.getObjectList ("BallerinaTest");
    int s3Status = response:getStatusCode(s3Response);
...
function testGetBucketList () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.getBucketList ();
    int s3Status = response:getStatusCode(s3Response);
    xml s3XmlResponse = response:getXmlPayload(s3Response);
...
function testDeleteObject () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.deleteObject ("BallerinaTest", "test.txt");
    int s3Status = response:getStatusCode(s3Response);
...
function testDeleteBucket () {
    amazons3:ClientConnector s3Connector = init();
    http:Response s3Response = s3Connector.deleteBucket ("BallerinaTest");
    int s3Status = response:getStatusCode(s3Response);
